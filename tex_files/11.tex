...
\begin{itemize}[itemsep = 2pt]
    ...
    Existuje i jeho vážená varianta, funguje podobně jako ostatní varinaty váženého průměru.
    ...
    Kdyby nebyla vzdálenost stejná, ale auto by jelo $80$ km/h 2 hodiny a $48$ km/h jen jednu hodinu, dosazená by vypadalo následovně:
    \[\overline{x_h} = \frac{3}{\frac{2}{80} + \frac{1}{48}} \doteq 65,5 km/h\]
    Toto je vážená varianta harmonického průměru.
...
\section*{Korelace}
Korelace se označuje \textbf{korelačním koeficientem $r$}, který nabývá hodnot $\langle -1,1 \rangle$. Pokud se $r = 1$ pak jde o přímou závislost, body leží přesně na roustoucí přímce. Pokud je $r = -1$, pak body leží na přímce $y = -x$. Pokud $r = 0$, pak je korelace nulová a body jsou rozptýleny náhodně.
