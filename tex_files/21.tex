...
Pokud chceme zjistit limitu podílu dvou funkcí v $f, g$, ale mají v limitě neurčitý výraz, tedy platí
buď $\lim_{x \to a}f(x) = lim_{x \to
...
Chceme vykopat bazén se čtvercovým dnem o objemu $V = 32 m^3$. Jak hluboký má být bazén, aby se
